            ...
            <div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
              ...
              <div class="col-md-12 heading-section ftco-animate">
                ...
                <ul class="about-info mt-4 px-md-0 px-2">
                    <li class="d-flex"><span>Name:</span> <span>MD.Jahid Rahman</span></li>
                    <li class="d-flex"><span>Date of birth:</span> <span>October 10, 2005</span></li>
                    <li class="d-flex"><span>Address:</span> <span>East Medda, Brahmanbaria, Bangladesh</span></li>
                    <li class="d-flex"><span>Zip code:</span> <span>3400</span></li>
